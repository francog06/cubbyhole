    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(intent_to_retrievepassword);
            }
        });
    }
    ...
    private class Login extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair(Utils.JSON_USER_EMAIL, "t@t.fr"));
                nameValuePairs.add(new BasicNameValuePair(Utils.JSON_USER_PASSWORD, "t"));

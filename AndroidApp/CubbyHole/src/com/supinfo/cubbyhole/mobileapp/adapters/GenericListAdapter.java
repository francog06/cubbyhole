	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (o != null){
			...
			if (o instanceof File){
				...
				iconImg.setImageDrawable(this.context.getResources().getDrawable(R.drawable.wc_file_blue));
				...
				if (folder.getIsFromShared()){
					iconImg.setImageDrawable(this.context.getResources().getDrawable(R.drawable.wc_folder_shared));  
				}else{
					iconImg.setImageDrawable(this.context.getResources().getDrawable(R.drawable.wc_folder_blue));  
				}
				...
				iconImg.setImageDrawable(this.context.getResources().getDrawable(R.drawable.wc_return));
